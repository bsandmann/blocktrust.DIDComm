...
public class JWEFixture
{
    public static List<JWETestVector> TEST_VECTORS = new List<JWETestVector>
    {
        new JWETestVector(
            message: """
                {
            ...
            expectedMetadata: new Metadata(
                ...
                encryptedTo: new List<string>
                {
                    "did:example:bob#key-x25519-1",
                    "did:example:bob#key-x25519-2",
                    "did:example:bob#key-x25519-3"
                },
                encAlgAnon: new AnonCryptAlg(AnonCryptAlg.XC20P_ECDH_ES_A256KW)
            )
        ),
        new JWETestVector(
            message: """
        ...
        new JWETestVector(
            ...
            expectedMetadata: new Metadata(
                ...
                encAlgAnon: new AnonCryptAlg(AnonCryptAlg.A256CBC_HS512_ECDH_ES_A256KW)
            )
        ),
        new JWETestVector(
            message: """
            ...
            expectedMetadata: new Metadata(
                ...
                encAlgAnon: new AnonCryptAlg(AnonCryptAlg.A256GCM_ECDH_ES_A256KW)
            )
        ),
        new JWETestVector(
            message: """
            ...
            expectedMetadata: new Metadata(
                ...
                encAlgAuth: new AuthCryptAlg(AuthCryptAlg.A256CBC_HS512_ECDH_1PU_A256KW)
            )
        ),
        new JWETestVector(
            message: """
        ...
        new JWETestVector(
            ...
            expectedMetadata: new Metadata(
                ...
                encryptedTo: new List<string>
                {
                    "did:example:bob#key-p521-1", "did:example:bob#key-p521-2"
                },
    ...
    public static readonly string BOB_DAMAGED_MESSAGE =
        """
                {
                   "ciphertext":"KWS7gJU7TbyJlcT9dPkCw-ohNigGaHSukR9MUqFM0THbCTCNkY-g5tahBFyszlKIKXs7qOtqzYyWbPou2q77XlAeYs93IhF6NvaIjyNqYklvj-OtJt9W2Pj5CLOMdsR0C30wchGoXd6wEQZY4ttbzpxYznqPmJ0b9KW6ZP-l4_DSRYe9B-1oSWMNmqMPwluKbtguC-riy356Xbu2C9ShfWmpmjz1HyJWQhZfczuwkWWlE63g26FMskIZZd_jGpEhPFHKUXCFwbuiw_Iy3R0BIzmXXdK_w7PZMMPbaxssl2UeJmLQgCAP8j8TukxV96EKa6rGgULvlo7qibjJqsS5j03bnbxkuxwbfyu3OxwgVzFWlyHbUH6p",
                   "protected":"",
    ...
    public static readonly string BOB_MESSAGE_WITHOUT_RECIPIENTS =
        """
                {
                   "ciphertext":"912eTUDRKTzhUUqxosPogT1bs9w9wv4s4HmoWkaeU9Uj92V4ENpk-_ZPNSvPyXYLfFj0nc9V2-ux5jq8hqUd17WJpXEM1ReMUjtnTqeUzVa7_xtfkbfhaOZdL8OfgNquPDH1bYcBshN9O9lMT0V52gmGaAB45k4I2PNHcc0A5XWzditCYi8wOkPDm5A7pA39Au5uUNiFQjRYDrz1YvJwV9cdca54vYsBfV1q4c8ncQsv5tNnFYQ1s4rAG7RbyWdAjkC89kE_hIoRRkWZhFyNSfdvRtlUJDlM19uml7lwBWWPnqkmQ3ubiBGmVct3pjrcDvjissOw8Dwkn4E1V1gafec-jDBy4Rndai_RdGjnXjMJs7nRv3Ot",
                   "protected":"",
    ...
    public static readonly string BOB_MESSAGE_WITHOUT_PROTECTED_HEADER =
        """
                {
                   "ciphertext":"912eTUDRKTzhUUqxosPogT1bs9w9wv4s4HmoWkaeU9Uj92V4ENpk-_ZPNSvPyXYLfFj0nc9V2-ux5jq8hqUd17WJpXEM1ReMUjtnTqeUzVa7_xtfkbfhaOZdL8OfgNquPDH1bYcBshN9O9lMT0V52gmGaAB45k4I2PNHcc0A5XWzditCYi8wOkPDm5A7pA39Au5uUNiFQjRYDrz1YvJwV9cdca54vYsBfV1q4c8ncQsv5tNnFYQ1s4rAG7RbyWdAjkC89kE_hIoRRkWZhFyNSfdvRtlUJDlM19uml7lwBWWPnqkmQ3ubiBGmVct3pjrcDvjissOw8Dwkn4E1V1gafec-jDBy4Rndai_RdGjnXjMJs7nRv3Ot",
                   "recipients":[
    ...
    public static readonly string BOB_MESSAGE_WITHOUT_CIPHERTEXT =
        """
                {
                   "protected":"",
                   "recipients":[
    ...
    public static readonly string BOB_MESSAGE_WITHOUT_TAG =
        """
                {
                   "ciphertext":"912eTUDRKTzhUUqxosPogT1bs9w9wv4s4HmoWkaeU9Uj92V4ENpk-_ZPNSvPyXYLfFj0nc9V2-ux5jq8hqUd17WJpXEM1ReMUjtnTqeUzVa7_xtfkbfhaOZdL8OfgNquPDH1bYcBshN9O9lMT0V52gmGaAB45k4I2PNHcc0A5XWzditCYi8wOkPDm5A7pA39Au5uUNiFQjRYDrz1YvJwV9cdca54vYsBfV1q4c8ncQsv5tNnFYQ1s4rAG7RbyWdAjkC89kE_hIoRRkWZhFyNSfdvRtlUJDlM19uml7lwBWWPnqkmQ3ubiBGmVct3pjrcDvjissOw8Dwkn4E1V1gafec-jDBy4Rndai_RdGjnXjMJs7nRv3Ot",
                   "protected":"",
    ...
    public static readonly string BOB_MESSAGE_WITHOUT_IV =
        """
                {
                   "ciphertext":"912eTUDRKTzhUUqxosPogT1bs9w9wv4s4HmoWkaeU9Uj92V4ENpk-_ZPNSvPyXYLfFj0nc9V2-ux5jq8hqUd17WJpXEM1ReMUjtnTqeUzVa7_xtfkbfhaOZdL8OfgNquPDH1bYcBshN9O9lMT0V52gmGaAB45k4I2PNHcc0A5XWzditCYi8wOkPDm5A7pA39Au5uUNiFQjRYDrz1YvJwV9cdca54vYsBfV1q4c8ncQsv5tNnFYQ1s4rAG7RbyWdAjkC89kE_hIoRRkWZhFyNSfdvRtlUJDlM19uml7lwBWWPnqkmQ3ubiBGmVct3pjrcDvjissOw8Dwkn4E1V1gafec-jDBy4Rndai_RdGjnXjMJs7nRv3Ot",
                   "protected":"",
    ...
    public static readonly string BOB_MESSAGE_UNSUPPORTED_ALG_HEADER =
        """
                {
                   "ciphertext":"912eTUDRKTzhUUqxosPogT1bs9w9wv4s4HmoWkaeU9Uj92V4ENpk-_ZPNSvPyXYLfFj0nc9V2-ux5jq8hqUd17WJpXEM1ReMUjtnTqeUzVa7_xtfkbfhaOZdL8OfgNquPDH1bYcBshN9O9lMT0V52gmGaAB45k4I2PNHcc0A5XWzditCYi8wOkPDm5A7pA39Au5uUNiFQjRYDrz1YvJwV9cdca54vYsBfV1q4c8ncQsv5tNnFYQ1s4rAG7RbyWdAjkC89kE_hIoRRkWZhFyNSfdvRtlUJDlM19uml7lwBWWPnqkmQ3ubiBGmVct3pjrcDvjissOw8Dwkn4E1V1gafec-jDBy4Rndai_RdGjnXjMJs7nRv3Ot",
    ...
    public static readonly string BOB_MESSAGE_UNSUPPORTED_ENC_HEADER =
        """
                {
                   "ciphertext":"912eTUDRKTzhUUqxosPogT1bs9w9wv4s4HmoWkaeU9Uj92V4ENpk-_ZPNSvPyXYLfFj0nc9V2-ux5jq8hqUd17WJpXEM1ReMUjtnTqeUzVa7_xtfkbfhaOZdL8OfgNquPDH1bYcBshN9O9lMT0V52gmGaAB45k4I2PNHcc0A5XWzditCYi8wOkPDm5A7pA39Au5uUNiFQjRYDrz1YvJwV9cdca54vYsBfV1q4c8ncQsv5tNnFYQ1s4rAG7RbyWdAjkC89kE_hIoRRkWZhFyNSfdvRtlUJDlM19uml7lwBWWPnqkmQ3ubiBGmVct3pjrcDvjissOw8Dwkn4E1V1gafec-jDBy4Rndai_RdGjnXjMJs7nRv3Ot",
    ...
    public static readonly string BOB_ANON_MESSAGE_RECIPIENT_KEY_IS_INVALID =
        """
                {
                   "ciphertext":"KWS7gJU7TbyJlcT9dPkCw-ohNigGaHSukR9MUqFM0THbCTCNkY-g5tahBFyszlKIKXs7qOtqzYyWbPou2q77XlAeYs93IhF6NvaIjyNqYklvj-OtJt9W2Pj5CLOMdsR0C30wchGoXd6wEQZY4ttbzpxYznqPmJ0b9KW6ZP-l4_DSRYe9B-1oSWMNmqMPwluKbtguC-riy356Xbu2C9ShfWmpmjz1HyJWQhZfczuwkWWlE63g26FMskIZZd_jGpEhPFHKUXCFwbuiw_Iy3R0BIzmXXdK_w7PZMMPbaxssl2UeJmLQgCAP8j8TukxV96EKa6rGgULvlo7qibjJqsS5j03bnbxkuxwbfyu3OxwgVzFWlyHbUH6p",
                   "protected":"",
    ...
    public static readonly string MESSAGE_ALICE_SKID_NOT_FOUND =
        """
                {
                   "ciphertext":"MJezmxJ8DzUB01rMjiW6JViSaUhsZBhMvYtezkhmwts1qXWtDB63i4-FHZP6cJSyCI7eU-gqH8lBXO_UVuviWIqnIUrTRLaumanZ4q1dNKAnxNL-dHmb3coOqSvy3ZZn6W17lsVudjw7hUUpMbeMbQ5W8GokK9ZCGaaWnqAzd1ZcuGXDuemWeA8BerQsfQw_IQm-aUKancldedHSGrOjVWgozVL97MH966j3i9CJc3k9jS9xDuE0owoWVZa7SxTmhl1PDetmzLnYIIIt-peJtNYGdpd-FcYxIFycQNRUoFEr77h4GBTLbC-vqbQHJC1vW4O2LEKhnhOAVlGyDYkNbA4DSL-LMwKxenQXRARsKSIMn7z-ZIqTE-VCNj9vbtgR",
    ...
    public static readonly string MESSAGE_ALICE_AND_BOB_KEYS_FROM_DIFFERENT_CURVES =
        """
                {
                   "ciphertext":"MJezmxJ8DzUB01rMjiW6JViSaUhsZBhMvYtezkhmwts1qXWtDB63i4-FHZP6cJSyCI7eU-gqH8lBXO_UVuviWIqnIUrTRLaumanZ4q1dNKAnxNL-dHmb3coOqSvy3ZZn6W17lsVudjw7hUUpMbeMbQ5W8GokK9ZCGaaWnqAzd1ZcuGXDuemWeA8BerQsfQw_IQm-aUKancldedHSGrOjVWgozVL97MH966j3i9CJc3k9jS9xDuE0owoWVZa7SxTmhl1PDetmzLnYIIIt-peJtNYGdpd-FcYxIFycQNRUoFEr77h4GBTLbC-vqbQHJC1vW4O2LEKhnhOAVlGyDYkNbA4DSL-LMwKxenQXRARsKSIMn7z-ZIqTE-VCNj9vbtgR",
                   "protected":"",
    ...
    public static readonly string MESSAGE_PROTECTED_HEADER_IS_NOT_BASE64_ENCODED =
        """
                    {
    ...
    public static readonly string ANONCRYPT_MESSAGE_P256_XC20P_EPK_WRONG_POINT =
        """
                {
    ...
    public static readonly List<NegativeTestVector<DidCommException>> NEGATIVE_TEST_VECTORS = new List<NegativeTestVector<DidCommException>>()
    {
        new NegativeTestVector<DidCommException>(
            packedMessage: "",
            expectedThrow: typeof(DidCommException),
        ...
        new NegativeTestVector<DidCommException>(
            ...
            expectedThrow: typeof(MalformedMessageException),
            expectedMessage: "The header \"id\" is missing",
            unpackParams: new UnpackParamsBuilder(
                    BOB_MESSAGE_WITHOUT_RECIPIENTS)
        ...
        new NegativeTestVector<DidCommException>(
            ...
            unpackParams: new UnpackParamsBuilder(
                    BOB_MESSAGE_WITHOUT_PROTECTED_HEADER)
                .ExpectDecryptByAllKeys(true)
                .BuildUnpackParams()
        ),
        ...
        new NegativeTestVector<DidCommException>(
            ...
            unpackParams: new UnpackParamsBuilder(
                    BOB_MESSAGE_WITHOUT_CIPHERTEXT)
                .ExpectDecryptByAllKeys(true)
                .BuildUnpackParams()
        ),
        ...
        new NegativeTestVector<DidCommException>(
            ...
            expectedThrow: typeof(UnsupportedAlgorithmException),
            expectedMessage: "The algorithm ECDH-ES+A255KW+XC20P is not supported",
            unpackParams: new UnpackParamsBuilder(
                    BOB_MESSAGE_UNSUPPORTED_ALG_HEADER)
                .ExpectDecryptByAllKeys(true)
                .BuildUnpackParams()
        ),
        ...
        new NegativeTestVector<DidCommException>(
            ...
            unpackParams: new UnpackParamsBuilder(
                    BOB_MESSAGE_UNSUPPORTED_ENC_HEADER)
                .ExpectDecryptByAllKeys(true)
                .BuildUnpackParams()
        ),
        ...
        new NegativeTestVector<DidCommException>(
            ...
            expectedMessage: "Decrypt is failed",
            unpackParams: new UnpackParamsBuilder(
                    BOB_ANON_MESSAGE_RECIPIENT_KEY_IS_INVALID)
                .ExpectDecryptByAllKeys(true)
                .BuildUnpackParams()
        ),
